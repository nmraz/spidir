...
void builder_callback32(spidir_builder_handle_t builder, void* ctx) {
    (void) ctx;
    ...
    spidir_value_t f = spidir_builder_build_fconst32(builder, 64.0);
...
int main(void) {
    ...
    spidir_function_t func32 = spidir_module_create_function(
        module, "func32", SPIDIR_TYPE_F32, 0, NULL);
    spidir_module_build_function(module, func32, builder_callback32, NULL);
