...
void builder_callback(spidir_builder_handle_t builder, void* ctx) {
    ...
    spidir_builder_build_store(builder, SPIDIR_MEM_SIZE_4, n, i_slot);
    spidir_builder_build_store(
        builder, SPIDIR_MEM_SIZE_4,
        spidir_builder_build_iconst(builder, SPIDIR_TYPE_I32, 0), sum_slot);
    ...
    spidir_value_t loop_cmp = spidir_builder_build_icmp(
        ...
        spidir_builder_build_load(builder, SPIDIR_MEM_SIZE_4, SPIDIR_TYPE_I32,
                                  i_slot),
    ...
    spidir_value_t i_val = spidir_builder_build_load(builder, SPIDIR_MEM_SIZE_4,
                                                     SPIDIR_TYPE_I32, i_slot);
    spidir_value_t sum_val = spidir_builder_build_load(
        builder, SPIDIR_MEM_SIZE_4, SPIDIR_TYPE_I32, sum_slot);
    ...
    spidir_builder_build_store(builder, SPIDIR_MEM_SIZE_4, next_i_val, i_slot);
    spidir_builder_build_store(builder, SPIDIR_MEM_SIZE_4, next_sum_val,
                               sum_slot);

    spidir_builder_build_branch(builder, loop_header);

    spidir_builder_set_block(builder, exit_block);
    spidir_value_t retval = spidir_builder_build_load(
        builder, SPIDIR_MEM_SIZE_4, SPIDIR_TYPE_I32, sum_slot);
