...
fn extract_node_kind(
    ...
    match node_kind_pair.as_str() {
        ...
        "lzcount" => Ok(NodeKind::Lzcount),
        "tzcount" => Ok(NodeKind::Tzcount),
        "popcount" => Ok(NodeKind::Popcount),
        "iext" => Ok(NodeKind::Iext),
        "itrunc" => Ok(NodeKind::Itrunc),
        "fadd" => Ok(NodeKind::Fadd),
        "fsub" => Ok(NodeKind::Fsub),
        "fmul" => Ok(NodeKind::Fmul),
        "fdiv" => Ok(NodeKind::Fdiv),
        "fwiden" => Ok(NodeKind::Fwiden),
        "fnarrow" => Ok(NodeKind::Fnarrow),
